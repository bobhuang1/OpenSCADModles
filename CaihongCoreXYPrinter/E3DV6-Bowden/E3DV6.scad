...
rotate([90, 0, 0])
cylinder(h=WallThickness, d=sensorholediameter+8, center=false, $fn=100);
}

translate([118.5, 75.4, 21])
rotate([90, 0, 0])
cylinder(h=WallThickness, d=sensorholediameter, center=false, $fn=100);
}
...
module base3D($Width=BaseWidth, $Depth=BaseDepth, $Height=BaseHeight, $Radius=import("C:/Users/Administrator/Desktop/Arduino/OpenSCADModles/E3DV6/E3D_V5_Blower_Proximity_Sensor_Mount_f.stl");
CornerRadius, $Thickness=WallThickness)
{
    difference()
    {
